...
namespace MapGenerator {
    ...
    void generate_mazes() {
        ...
        std::cout << "sector status: " << sector_status << "\n";
    ...
    void generate_voids() {
        ...
        if (voidPossibleLocations.empty()) std::cout << "Alert: No voids spawned! voidPossibleLocations.empty()";
